    ...
    def schedule(self) -> SchedulerOutput:
        ...
        while req_index < len(self.running) and token_budget > 0:
            ...
            if (
                ...
                and hard_capacity < requested_num_new_tokens
            ):
                # This complete tree can never fit before max_model_len. Drop
                # both payload and topology and recompute root-only work;
                # repeatedly deferring it would deadlock the request.
